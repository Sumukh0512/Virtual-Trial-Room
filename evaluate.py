...
def get_arguments():
    ...
    parser.add_argument("--input", type=str, default='static/Database/val/image/', help="path of input image folder.")
    parser.add_argument("--output", type=str, default='static/Database/val/image-parse', help="path of output image folder.")
